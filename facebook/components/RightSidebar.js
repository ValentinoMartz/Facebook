...
const RightSidebar = () => {
  ...
  return (
    <div>
      <div className="hidden lg:block sm:pt-8 pt-4 pr-7">
          ...
          {profiles.map((profile) => (
            <div className="flex items-center">
              <div className="flex relative w-12 h-12">
                ...
                />
                <div className="absolute w-3.5 h-3.5 bg-green-500 rounded-full bottom-0 right-0.5 p-1 border-2 border-white"></div>
              </div>
